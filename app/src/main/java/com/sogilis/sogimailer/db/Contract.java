...
public class Contract {
	...
	public static abstract class DefaultProfile implements BaseColumns {
		public static final String TABLE_NAME                      = "default_profile";
		public static final String COLUMNE_NAME_DEFAULT_PROFILE_ID = "default_profile_id";
	}
